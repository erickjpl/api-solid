 ...
 *
 * @property \Illuminate\Database\Eloquent\Collection $rengAjus
 ...
 */
class TipoAju extends Model
{
    use HasFactory;

    public $table = 'tipo_aju';
    ...
    public static $rules = [
        ...
        'tipo_trans' => 'required|string|max:1',
     ...
     **/
    public function rengAjus()
    {
        return $this->hasMany(\App\Models\Sincronizador\RengAju::class, 'tipo');
    }
}
